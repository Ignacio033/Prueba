...
@HippoEssentialsGenerated(internalName = "project:contentdocument")
@Node(jcrType = "project:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "project:introduction")
    public String getIntroduction() {
        return getProperty("project:introduction");
    }
    ...
    @HippoEssentialsGenerated(internalName = "project:publicationdate")
    public Calendar getPublicationDate() {
        return getProperty("project:publicationdate");
    }
}
